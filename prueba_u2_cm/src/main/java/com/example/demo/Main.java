...
public class Main implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		//this.gestorService.agendamientoCita("001", LocalDateTime.of(2021, 03, 10, 13, 53), new BigDecimal(40), "Quito"
				//, "123456", "124356");

		//funcionalidad 4
		log.info("****************funcionalidad 4*************");
		//this.gestorService.actualizacionCita("001", "se va a morir" , "reposo eterno", LocalDateTime.of(2022, 03, 10, 13, 53));
